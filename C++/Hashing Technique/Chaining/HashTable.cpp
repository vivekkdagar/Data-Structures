...
HashTable::HashTable() {            /* Create a hashtable which is basically a double pointer to an array of node * in heap
...
void HashTable::insert(int key) {           // Sorted insert.
...
int HashTable::search(int key) {            // Pick the head node of the key w.r.t its hashcode and start searching.
